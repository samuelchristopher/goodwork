...
{% block content %}
  <div class="container">
    <div class="page-header">
      <h1>GoodWork Privacy Policy</h1>
    </div>


    <p>
      This Privacy Policy was last modified on Jul 21, 2015.
    </p>

    <p>
      GoodWork ("us", "we", or "our") operates http://goodwork.pe.hu (the "Site"). This page informs you of our policies regarding the collection, use and disclosure
...
its absolute security.
    ...
    <p>
      GoodWork may update this Privacy Policy from time to time. We will notify
