  ...
  <div class="container">
    <div class="jumbotron">
      <div style="padding-left: 20px;">
        ...
        <p>This is where you will be, for the rest of your employing life. So get comfortable :)</p>
        <!-- <p><a class="btn btn-primary btn-lg" href="#" role="button">Learn more</a></p> -->
      </div>
    </div>

    <ul class="nav nav-tabs" id="tabs">
      <li role="presentation" class="active"><a href="#search" class="tab-link">Search</a></li>
    ...
    <div id="schools">
      <div class="page-header">
        <h1>Search <small>{{ auth.country }}</small></h1>
      </div>
